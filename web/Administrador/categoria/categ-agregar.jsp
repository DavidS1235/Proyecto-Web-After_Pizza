...
<html>
    <head>
        ...
        <title>After Pizza - Agregar Categoría</title>
    </head>
    <body>
        ...
        <div class="container2">
            <div class="tittle-E">Zona Categorias » Agregar</div>
            ...
            <div class="formulario">
                <form action="ControlCategoria" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="Lname" name="nomcateg" placeholder="Nombre de categoría">
                        </div>
                    </div>
