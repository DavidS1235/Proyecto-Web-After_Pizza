        ...
        <div class="container">
            <div class="nav-var">
                ...
                <div class="nav-text">
                    ...
                    <!--<div class="nav-text3"><a href="carrito.html" id="link">Carrito</a></div>-->
                </div>
                <div class="nav-log-in"><a href="logIn.jsp"><button type="button" class="btn btn-primary">Log
                            in</button></a></div>
            </div>
            <div class="container-fluid d-flex align-self-sm-center">
                <div class="col-12 align-self-sm-center">
                    <iframe src="https://www.google.com/maps/d/embed?mid=1eUlydtgC9zHtXVH38APA6TzPsGVo5M4v" width="100%"
                            height="550px"></iframe>
                </div>
            </div>
